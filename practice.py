...
while True :
     def money_cut():
          ...
          value_currency={f"The change of {x} dollars is  {numberQ} quaters , {numberD} dimes , {numberN} nickles , and {numberP} pennies"}
          return value_currency
     value_currency_1 = money_cut()
     print(value_currency_1)
